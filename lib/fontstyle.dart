...
class Styles{
  ...
  static Color buttonColor = const Color(0xff8b73ff);
  ...
  static TextStyle headLineStyle1 = const TextStyle(fontSize: 26, color: Colors.black, fontWeight: FontWeight.bold);
